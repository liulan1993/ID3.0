...
const testimonialsData: Testimonial[] = [
    {
      img: '',
      quote: "提供公司注册、准证、财税与人力资源落地服务，助力企业高效拓展，稳健致远。",
      role: '企业服务',
    },
    {
      img: '',
      quote: "深度定制孩子最优成长路径，提供高瞻远瞩的全方位教育解决方案。",
      role: '留学教育',
    },
    {
      img: '',
      quote: "溯源生命数据，深度整合中新顶尖医疗资源，为您及家人构建专属健康管理体系。",
      role: '健康管理',
    },
    {
      img: '',
      quote: "运用AI与数字解决方案，协助客户构建线上平台，实现高效出海与数字化转型。",
      role: '技术赋能',
    },
];
